...
class _SleepVuiScreenState extends ConsumerState<SleepVuiScreen>
  ...
  void initState() {
    ...
    assert(() {
      debugPrint(
        'SleepScreen init — local hour: ${DateTime.now().toLocal().hour}, period: ${_period.name}',
      );
      return true;
    }());
      ...
      if (next.pendingRoute != null) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            ...
            content: Text(
              'Navigating to ${next.pendingRoute}',
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (state.tips != null && state.tips!.isNotEmpty) ...[
                            ...
                            ...state.tips!.map(
                              (t) => _SleepTipCard(tip: t, theme: theme),
                            ),
                          ],
...
class _SkyBackground extends StatefulWidget {
  ...
  const _SkyBackground({required this.scrollController, required this.period});
...
class _SkyBackgroundState extends State<_SkyBackground>
  ...
  void initState() {
    ...
    _celestialRiseAnim = Tween<double>(
      begin: 0,
      end: 1,
    ).animate(CurvedAnimation(parent: _celestialRise, curve: Curves.easeInOut));
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: RadialGradient(
                    colors: [
                      theme.nebulaColor1.withValues(alpha: 0.07),
                      Colors.transparent,
                    ],
                  ),
                ),
            ...
            Positioned(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: RadialGradient(
                    colors: [
                      theme.nebulaColor2.withValues(alpha: 0.08),
                      Colors.transparent,
                    ],
                  ),
                ),
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: RadialGradient(
                      colors: [
                        theme.horizonGlowColor.withValues(
                          alpha: theme.horizonGlowOpacity,
                        ),
                        Colors.transparent,
                      ],
                    ),
...
class _MicSection extends StatelessWidget {
  ...
  String _label(SleepVuiStatus s) {
    switch (s) {
      case SleepVuiStatus.listening:
        return 'Listening…';
      case SleepVuiStatus.processing:
        return 'Thinking…';
      case SleepVuiStatus.speaking:
        return 'Speaking…';
      default:
        return '';
    }
